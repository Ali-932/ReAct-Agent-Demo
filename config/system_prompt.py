...
- Update the confidence level based on the accuracy of the reasoning and the output obtained.
- Follow the output schema when generating a response.
- For every step, the 'thought' should be send as output response to the 
- When writing sql queries, take every possibility into account 
